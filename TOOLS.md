...
| `get_homebridge_product_media` | Returns bounded Shopify media resources, a native inline image preview, and an exact Markdown image fallback; an exact SKU resolves its variant ID and prioritizes Shopify-associated media. | None |
